...
var asd="";
function ini(){
   /* $.getJSON("http://eldesarrollodemiweb.com/phpApp/consulta_enlaces.php",
    function (data){
        if(data.datos=="si"){
    ...
    $.ajax({
       ...
       success: function(data){
            ...
            $.each(data.consultaOficinas, function(key, value){
                var phones=value.telefonos.replace("%%%", "<br>");
                //alert(phones);
                lista+='<li>';
                ...
                lista+='<a href="#" class="ui-btn-right ui-btn ui-btn-inline ui-mini ui-corner-all ui-btn-icon-right deback" data-rel=""><i class="fa fa-phone fa-2x"></i></a>';
                lista+='<br/><br/>';
                lista+='<a href="#"" class="ui-btn-right ui-btn ui-btn-inline ui-mini ui-corner-all ui-btn-icon-right deback" data-rel=""><i class="fa fa-whatsapp fa-2x"></i></a>';
                lista+='</div>';
                lista+='</div>';
                lista+='</li>';
            });
